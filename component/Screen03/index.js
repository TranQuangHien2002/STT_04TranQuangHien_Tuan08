...
export default function Screen03({navigation, route}) {
    ...
    const handleClickFinish = async ()=>{
        ...
        if (route.params?.action == "add"){
            ...
            setIsSubmit(true);
            const res = await fetch("https://6458b4584eb3f674df7ad4d8.mockapi.io/todolist", { 
                method: "POST",
                headers: {
            ...
            setIsSubmit(true);
            const res = await fetch(`https://6458b4584eb3f674df7ad4d8.mockapi.io/todolist/${route.params?.data?.id}`, { 
                method: "PUT",
                headers: {
                    "Content-Type": "application/json"
                },
